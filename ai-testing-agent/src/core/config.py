...
class Settings(BaseSettings):
    # LLM配置
    DEEPSEEK_API_KEY: str = "sk-dcca1d2d23cb436ea6c7a9b89cd07815"
    ...
    IMAGE_PARSER_API_KEY: str = os.getenv("IMAGE_PARSER_API_KEY", "1252cc17-0062-45b2-b284-31af801ae835")
...
- 开头和结尾不要添加 ```markdown 标记""").strip()
    ...
    # SKILL 路径配置
    SKILL_PATH: str = os.getenv("SKILL_PATH", r"D:\owin\AI\huice5\finally\system\ai-test-agent-system\src\workspace\testcase")
