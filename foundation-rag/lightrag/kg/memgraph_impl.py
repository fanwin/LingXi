...
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZRV2xPYmc9PTo5OTI2NDkxMg==
    ...
    async def initialize(self):
        async with get_data_init_lock():
            ...
            try:
                ...
                raise
# pragma: no cover  MS80OmFIVnBZMlhvaklQb3RvVTZRV2xPYmc9PTo5OTI2NDkxMg==
    ...
    async def upsert_node(self, node_id: str, node_data: dict[str, str]) -> None:
        ...
        for attempt in range(max_retries):
            try:
                ...
                raise
# noqa  Mi80OmFIVnBZMlhvaklQb3RvVTZRV2xPYmc9PTo5OTI2NDkxMg==
...
# fmt: off  My80OmFIVnBZMlhvaklQb3RvVTZRV2xPYmc9PTo5OTI2NDkxMg==
