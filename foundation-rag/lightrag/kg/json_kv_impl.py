...
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZUSGRSV2c9PTpkMTNkYmRiNQ==
...
# fmt: off  MS80OmFIVnBZMlhvaklQb3RvVTZUSGRSV2c9PTpkMTNkYmRiNQ==
        ...
        async with self._storage_lock:
            ...
            for k, v in data.items():
                ...
                if k in self._data:  # Key exists, only update update_time
                    ...
                    v["update_time"] = current_time
# noqa  Mi80OmFIVnBZMlhvaklQb3RvVTZUSGRSV2c9PTpkMTNkYmRiNQ==
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        migrated_data = {}
        migration_count = 0
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZUSGRSV2c9PTpkMTNkYmRiNQ==
