...
# type: ignore  MC80OmFIVnBZMlhvaklQb3RvVTZNM0E0Unc9PToxY2QzOGViOQ==
...
async def parse_request_body(
    ...
    try:
        if content_type.startswith("application/json"):
            ...
            body_bytes = await request.body()
            body = json.loads(body_bytes.decode("utf-8"))
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZNM0E0Unc9PToxY2QzOGViOQ==
...
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZNM0E0Unc9PToxY2QzOGViOQ==
...
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZNM0E0Unc9PToxY2QzOGViOQ==
