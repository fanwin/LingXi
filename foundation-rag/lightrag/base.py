...
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZaalkwTkE9PTpiOGNhM2U4MA==
...
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZaalkwTkE9PTpiOGNhM2U4MA==
...
class BaseVectorStorage(StorageNameSpace, ABC):
    ...
    def _generate_collection_suffix(self) -> str | None:
        ...
        """
        import re
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZaalkwTkE9PTpiOGNhM2U4MA==
...
class BaseGraphStorage(StorageNameSpace, ABC):
    ...
    async def node_degrees_batch(self, node_ids: list[str]) -> dict[str, int]:
        ...
        return result
# fmt: off  My80OmFIVnBZMlhvaklQb3RvVTZaalkwTkE9PTpiOGNhM2U4MA==
