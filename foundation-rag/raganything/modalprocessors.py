...
class ContextExtractor:
    ...
    def _extract_from_content_list(
        ...
        if self.config.context_mode == "page":
            ...
            return self._extract_page_context(content_list, current_item_info)
# noqa  MC80OmFIVnBZMlhvaklQb3RvVTZRMmROY1E9PTo0YTBiNmNjZA==
    ...
    def _extract_chunk_context(
        ...
        context = "\n".join(context_texts)
        return self._truncate_context(context)
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZRMmROY1E9PTo0YTBiNmNjZA==
...
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZRMmROY1E9PTo0YTBiNmNjZA==
...
class BaseModalProcessor:
    ...
    def _get_context_for_item(self, item_info: Dict[str, Any]) -> str:
        ...
        if not self.content_source:
            return ""
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZRMmROY1E9PTo0YTBiNmNjZA==
