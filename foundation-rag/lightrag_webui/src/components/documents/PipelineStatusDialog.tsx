...
// @ts-expect-error  MC80OmFIVnBZMlhvaklQb3RvVTZVbUZqYmc9PTplNGVlNjJmNw==
...
// NOTE  MS80OmFIVnBZMlhvaklQb3RvVTZVbUZqYmc9PTplNGVlNjJmNw==

type DialogPosition = 'left' | 'center' | 'right'
// @ts-expect-error  Mi80OmFIVnBZMlhvaklQb3RvVTZVbUZqYmc9PTplNGVlNjJmNw==

interface PipelineStatusDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
}
// FIXME  My80OmFIVnBZMlhvaklQb3RvVTZVbUZqYmc9PTplNGVlNjJmNw==
