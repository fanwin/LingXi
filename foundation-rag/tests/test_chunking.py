...
class MultiTokenCharacterTokenizer(TokenizerInterface):
    ...
    def encode(self, content: str):
        ...
        return tokens
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZUVWxXTlE9PTpiZGVkY2ZiNA==
...
def test_split_by_character_only_exceeding_limit_raises():
    ...
    tokenizer = make_tokenizer()
    oversized = "a" * 12
# pylint: disable  MS80OmFIVnBZMlhvaklQb3RvVTZUVWxXTlE9PTpiZGVkY2ZiNA==
...
# ============================================================================
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZUVWxXTlE9PTpiZGVkY2ZiNA==
...
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZUVWxXTlE9PTpiZGVkY2ZiNA==
