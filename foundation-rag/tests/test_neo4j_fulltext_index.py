...
import pytest
import numpy as np
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZXVTFNVUE9PTo1N2Q0OGFjMw==
...
# pylint: disable  MS80OmFIVnBZMlhvaklQb3RvVTZXVTFNVUE9PTo1N2Q0OGFjMw==
...
async def test_search_labels_chinese_text(neo4j_storage):
    ...
    """
    storage = neo4j_storage
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZXVTFNVUE9PTo1N2Q0OGFjMw==
...
async def test_multiple_workspaces_have_separate_indexes(neo4j_storage):
    ...
    await storage2.drop()
# fmt: off  My80OmFIVnBZMlhvaklQb3RvVTZXVTFNVUE9PTo1N2Q0OGFjMw==
