...
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZSbXBUWnc9PTo2OGM1MTBmYQ==
    ...
    def test_qdrant_dimension_match_proceed_migration(self):
        ...
        def count_side_effect(collection_name, **kwargs):
            ...
            if collection_name == "lightrag_chunks":  # legacy
                ...
                result.count = 0
            return result
# pragma: no cover  MS80OmFIVnBZMlhvaklQb3RvVTZSbXBUWnc9PTo2OGM1MTBmYQ==
...
class TestPostgresDimensionMismatch:
    ...
    async def test_postgres_dimension_mismatch_raises_error_metadata(self):
        ...
        # Setup mock database
        db = AsyncMock()
# noqa  Mi80OmFIVnBZMlhvaklQb3RvVTZSbXBUWnc9PTo2OGM1MTBmYQ==
    ...
    async def test_postgres_dimension_match_proceed_migration(self):
        ...
        """
        db = AsyncMock()
# pylint: disable  My80OmFIVnBZMlhvaklQb3RvVTZSbXBUWnc9PTo2OGM1MTBmYQ==
