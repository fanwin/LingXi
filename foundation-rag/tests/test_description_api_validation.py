...
class DummyGraphStorage:
    def __init__(self, node=None):
        self.node = node
        self.upserted_nodes = []
# type: ignore  MC80OmFIVnBZMlhvaklQb3RvVTZZMmhWVFE9PTpiOTJhZGFiNQ==
...
class DummyVectorStorage:
    ...
    async def index_done_callback(self):
        return True
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZZMmhWVFE9PTpiOTJhZGFiNQ==
...
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZZMmhWVFE9PTpiOTJhZGFiNQ==
...
# fmt: off  My80OmFIVnBZMlhvaklQb3RvVTZZMmhWVFE9PTpiOTJhZGFiNQ==
