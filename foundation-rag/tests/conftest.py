...
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZkMkZOVnc9PTpiODc1YzVhOQ==
...
# pylint: disable  MS80OmFIVnBZMlhvaklQb3RvVTZkMkZOVnc9PTpiODc1YzVhOQ==
...
def stress_test_mode(request):
    ...
    if request.config.getoption("--stress-test"):
        return True
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZkMkZOVnc9PTpiODc1YzVhOQ==
...
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZkMkZOVnc9PTpiODc1YzVhOQ==
