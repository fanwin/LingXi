...
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZXRGRqV2c9PTpkNzY5ZTA0Mw==
...
class TestAggregateChunkScores:
    ...
    def test_no_chunking_simple_aggregation(self):
        ...
        num_original_docs = 3
# pylint: disable  MS80OmFIVnBZMlhvaklQb3RvVTZXRGRqV2c9PTpkNzY5ZTA0Mw==
...
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZXRGRqV2c9PTpkNzY5ZTA0Mw==
...
class TestTopNWithChunking:
    ...
    async def test_top_n_not_modified_when_chunking_disabled(self):
        ...
        def capture_post(*args, **kwargs):
            captured_payload.update(kwargs.get("json", {}))
            return mock_response
# pylint: disable  My80OmFIVnBZMlhvaklQb3RvVTZXRGRqV2c9PTpkNzY5ZTA0Mw==
