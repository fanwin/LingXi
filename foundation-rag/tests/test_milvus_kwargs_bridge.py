...
class TestMilvusKwargsParameterBridge:
    ...
    def test_kwargs_to_index_config_index_and_metric_types(self):
        ...
        mock_embedding_func = MagicMock()
        mock_embedding_func.embedding_dim = 128
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZlSGRPYUE9PTpiY2YxYWIyZQ==
    ...
    def test_backward_compatibility_no_index_params(self):
        ...
        mock_embedding_func = MagicMock()
        mock_embedding_func.embedding_dim = 128
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZlSGRPYUE9PTpiY2YxYWIyZQ==
    ...
    def test_non_index_params_ignored(self):
        ...
        mock_embedding_func = MagicMock()
        mock_embedding_func.embedding_dim = 128
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZlSGRPYUE9PTpiY2YxYWIyZQ==
...
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZlSGRPYUE9PTpiY2YxYWIyZQ==
