...
// FIXME  MC80OmFIVnBZMlhvaklQb3RvVTZZamxQZVE9PToyZjljYmIyYw==

type Theme = 'dark' | 'light' | 'system'
type Language = 'en' | 'zh' | 'fr' | 'ar' | 'zh_TW' | 'ru' | 'ja' | 'de' | 'uk' | 'ko'
type Tab = 'documents' | 'knowledge-graph' | 'retrieval' | 'api'
// NOTE  MS80OmFIVnBZMlhvaklQb3RvVTZZamxQZVE9PToyZjljYmIyYw==
...
// FIXME  Mi80OmFIVnBZMlhvaklQb3RvVTZZamxQZVE9PToyZjljYmIyYw==

const useSettingsStore = createSelectors(useSettingsStoreBase)
// NOTE  My80OmFIVnBZMlhvaklQb3RvVTZZamxQZVE9PToyZjljYmIyYw==
