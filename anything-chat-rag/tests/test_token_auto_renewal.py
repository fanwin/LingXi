...
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZja2RDVnc9PTowZGFlODZhYQ==
    ...
    def test_token_renewal_for_guest_mode(
        ...
        _token_renewal_cache.clear()
# fmt: off  MS80OmFIVnBZMlhvaklQb3RvVTZja2RDVnc9PTowZGFlODZhYQ==
...
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZja2RDVnc9PTowZGFlODZhYQ==
    ...
    def test_rate_limit_per_user(self, mock_auth_handler):
        ...
        # Use global cache
        global _token_renewal_cache
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZja2RDVnc9PTowZGFlODZhYQ==
