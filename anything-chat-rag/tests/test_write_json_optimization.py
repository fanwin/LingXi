...
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZjWGh0ZWc9PTo4YjZlNTY0Ng==
...
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZjWGh0ZWc9PTo4YjZlNTY0Ng==
    ...
    def test_migration_with_surrogate_sanitization(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".json") as f:
            temp_file = f.name
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZjWGh0ZWc9PTo4YjZlNTY0Ng==
        ...
        try:
            ...
            os.unlink(temp_file)
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZjWGh0ZWc9PTo4YjZlNTY0Ng==
