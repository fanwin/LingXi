...
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZTemhwYmc9PToxOTFkMjUwYg==
    ...
    def test_overlap_equal_to_max_tokens(self):
        ...
        assert len(chunked_docs) > 0
        assert all(idx == 0 for idx in doc_indices)
# type: ignore  MS80OmFIVnBZMlhvaklQb3RvVTZTemhwYmc9PToxOTFkMjUwYg==
...
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZTemhwYmc9PToxOTFkMjUwYg==
    ...
    def test_edge_case_max_tokens_one(self):
        ...
        assert len(chunked_docs) > 0
        assert all(idx == 0 for idx in doc_indices)
# pylint: disable  My80OmFIVnBZMlhvaklQb3RvVTZTemhwYmc9PToxOTFkMjUwYg==
