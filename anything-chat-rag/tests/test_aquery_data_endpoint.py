...
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZNRFJ4VHc9PTo3ZjcxNzhkZA==
...
def parse_streaming_response(
    ...
    for line in lines:
        ...
        try:
            ...
            continue
# type: ignore  MS80OmFIVnBZMlhvaklQb3RvVTZNRFJ4VHc9PTo3ZjcxNzhkZA==
...
def test_query_endpoint_references():
    ...
    print("\n🧪 Test 2: References disabled")
    print("-" * 40)
# type: ignore  Mi80OmFIVnBZMlhvaklQb3RvVTZNRFJ4VHc9PTo3ZjcxNzhkZA==
...
def test_query_stream_endpoint_references():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if not validate_references_format(references):
                return False
# pylint: disable  My80OmFIVnBZMlhvaklQb3RvVTZNRFJ4VHc9PTo3ZjcxNzhkZA==
