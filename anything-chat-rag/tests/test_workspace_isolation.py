...
# Pytest Fixtures
# =============================================================================
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZiVFpWVEE9PTpjNWRhY2IyNg==
...
def _assert_no_timeline_overlap(timeline: List[Tuple[str, str]]) -> None:
    ...
    for name, event in timeline:
        if event == "start":
            ...
            active_task = None
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZiVFpWVEE9PTpjNWRhY2IyNg==
...
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZiVFpWVEE9PTpjNWRhY2IyNg==
...
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZiVFpWVEE9PTpjNWRhY2IyNg==
