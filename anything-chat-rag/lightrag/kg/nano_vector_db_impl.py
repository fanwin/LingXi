...
# pragma: no cover  MC80OmFIVnBZMlhvaklQb3RvVTZNR2x2VkE9PTpiMDdhNWUwNA==
...
# fmt: off  MS80OmFIVnBZMlhvaklQb3RvVTZNR2x2VkE9PTpiMDdhNWUwNA==
...
# pragma: no cover  Mi80OmFIVnBZMlhvaklQb3RvVTZNR2x2VkE9PTpiMDdhNWUwNA==
    ...
    async def drop(self) -> dict[str, str]:
        ...
        try:
            async with self._storage_lock:
                ...
                # Reset own update flag to avoid self-reloading
                self.storage_updated.value = False
# fmt: off  My80OmFIVnBZMlhvaklQb3RvVTZNR2x2VkE9PTpiMDdhNWUwNA==
