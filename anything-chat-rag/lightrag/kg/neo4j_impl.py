...
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZhek42Vmc9PTpmYmQ1ZDQzZg==
...
# pylint: disable  MS80OmFIVnBZMlhvaklQb3RvVTZhek42Vmc9PTpmYmQ1ZDQzZg==
            ...
            async with driver.session(database=database) as session:
                ...
                for idx in indexes:
                    ...
                    if existing_index and legacy_index:
                        break
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZhek42Vmc9PTpmYmQ1ZDQzZg==
    ...
    async def get_node(self, node_id: str) -> dict[str, str] | None:
        ...
        async with self._driver.session(
            ...
            try:
                ...
                raise
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZhek42Vmc9PTpmYmQ1ZDQzZg==
