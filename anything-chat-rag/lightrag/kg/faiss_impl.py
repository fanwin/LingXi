...
# fmt: off  MC80OmFIVnBZMlhvaklQb3RvVTZlVGx5YkE9PToyYTAyMDg5NQ==
...
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZlVGx5YkE9PToyYTAyMDg5NQ==
    ...
    async def _remove_faiss_ids(self, fid_list):
        ...
        async with self._storage_lock:
            ...
            if vectors_to_keep:
                ...
                self._index.add(arr)
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZlVGx5YkE9PToyYTAyMDg5NQ==
...
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZlVGx5YkE9PToyYTAyMDg5NQ==
