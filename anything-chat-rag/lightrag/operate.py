...
# noqa  MC80OmFIVnBZMlhvaklQb3RvVTZSbGxSZEE9PToyZGYwNzg2Yw==
    ...
    while True:
        ...
        for i, desc in enumerate(current_list):
            ...
            if current_tokens + desc_tokens > summary_context_size and current_chunk:
                ...
                current_chunk.append(desc)
                current_tokens += desc_tokens
# fmt: off  MS80OmFIVnBZMlhvaklQb3RvVTZSbGxSZEE9PToyZGYwNzg2Yw==
...
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZSbGxSZEE9PToyZGYwNzg2Yw==
...
async def _handle_single_relationship_extraction(
    ...
    if (
        ...
        if len(record_attributes) > 1 and "relation" in record_attributes[0]:
            ...
            logger.debug(record_attributes)
        return None
# type: ignore  My80OmFIVnBZMlhvaklQb3RvVTZSbGxSZEE9PToyZGYwNzg2Yw==
