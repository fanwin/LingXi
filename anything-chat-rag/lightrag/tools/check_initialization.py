...
async def check_lightrag_setup(rag_instance: LightRAG, verbose: bool = False) -> bool:
    ...
    issues = []
    warnings = []
# type: ignore  MC80OmFIVnBZMlhvaklQb3RvVTZOMFpZZEE9PToyOTNiY2YwMQ==
...
# pragma: no cover  MS80OmFIVnBZMlhvaklQb3RvVTZOMFpZZEE9PToyOTNiY2YwMQ==
    ...
    if issues:
        ...
        return True
# fmt: off  Mi80OmFIVnBZMlhvaklQb3RvVTZOMFpZZEE9PToyOTNiY2YwMQ==
...
# type: ignore  My80OmFIVnBZMlhvaklQb3RvVTZOMFpZZEE9PToyOTNiY2YwMQ==
