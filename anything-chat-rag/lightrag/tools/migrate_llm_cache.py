...
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZkRFIxUWc9PTo4OTlhZWE3NA==
...
# pragma: no cover  MS80OmFIVnBZMlhvaklQb3RvVTZkRFIxUWc9PTo4OTlhZWE3NA==
    ...
    async def initialize_storage(self, storage_name: str, workspace: str):
        ...
        return storage
# type: ignore  Mi80OmFIVnBZMlhvaklQb3RvVTZkRFIxUWc9PTo4OTlhZWE3NA==
    ...
    async def get_default_caches_json(self, storage) -> Dict[str, Any]:
        ...
        async with storage._storage_lock:
            ...
            return filtered
# type: ignore  My80OmFIVnBZMlhvaklQb3RvVTZkRFIxUWc9PTo4OTlhZWE3NA==
