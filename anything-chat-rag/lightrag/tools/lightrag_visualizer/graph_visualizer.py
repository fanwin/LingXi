...
# noqa  MC80OmFIVnBZMlhvaklQb3RvVTZhMEp0V0E9PTo3YzFlNGRmMg==
    ...
    def handle_keyboard_input(self):
        ...
        if io.want_capture_keyboard:
            return
# noqa  MS80OmFIVnBZMlhvaklQb3RvVTZhMEp0V0E9PTo3YzFlNGRmMg==
    ...
    def handle_mouse_interaction(self):
        ...
        for button in range(3):
            ...
            if imgui.is_mouse_released(button) and self.mouse_button == button:
                self.mouse_pressed = False
                self.mouse_button = -1
# type: ignore  Mi80OmFIVnBZMlhvaklQb3RvVTZhMEp0V0E9PTo3YzFlNGRmMg==
...
# pragma: no cover  My80OmFIVnBZMlhvaklQb3RvVTZhMEp0V0E9PTo3YzFlNGRmMg==
