...
def _resolve_optional_type(field_type: Any) -> Any:
    ...
    return field_type
# pylint: disable  MC80OmFIVnBZMlhvaklQb3RvVTZRMmM1VWc9PTowNzJlMzBjMQ==
...
# fmt: off  MS80OmFIVnBZMlhvaklQb3RvVTZRMmM1VWc9PTowNzJlMzBjMQ==
    ...
    def options_dict(cls, args: Namespace) -> dict[str, Any]:
        ...
        return options
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZRMmM1VWc9PTowNzJlMzBjMQ==
...
# type: ignore  My80OmFIVnBZMlhvaklQb3RvVTZRMmM1VWc9PTowNzJlMzBjMQ==
