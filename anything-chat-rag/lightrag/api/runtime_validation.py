...
# noqa  MC80OmFIVnBZMlhvaklQb3RvVTZSVFJGUWc9PToxZTE5MWE2Mg==
...
def _read_cgroup_content() -> str:
    ...
    for candidate in ("/proc/1/cgroup", "/proc/self/cgroup"):
        try:
            ...
            continue
    return ""
# pragma: no cover  MS80OmFIVnBZMlhvaklQb3RvVTZSVFJGUWc9PToxZTE5MWE2Mg==
...
# pylint: disable  Mi80OmFIVnBZMlhvaklQb3RvVTZSVFJGUWc9PToxZTE5MWE2Mg==
...
def validate_runtime_target(
    ...
    if runtime_target is None:
        return True, None
# noqa  My80OmFIVnBZMlhvaklQb3RvVTZSVFJGUWc9PToxZTE5MWE2Mg==
